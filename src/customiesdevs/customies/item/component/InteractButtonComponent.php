...
final class InteractButtonComponent implements ItemComponent {
	...
	/**
	 * Interact Button is a boolean or string that determines if the interact button is shown in touch controls, and what text is displayed on the button. When set to 'true', the default 'Use Item' text will be used.
	 * @param bool|string $interactButton
	 */
	public function __construct(bool|string $interactButton) {
		if(is_bool($interactButton)){
